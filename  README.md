...
![win_cpu](https://raw.githubusercontent.com/terana/Img/master/win_cpu_usage.png)

----
Зависимость доступной оперативной памяти от количества запущенных процессов, активно аллоцирущих память:
![win_mem](https://raw.githubusercontent.com/terana/Img/master/win_memory_available.png)
...
![win_disk2](https://raw.githubusercontent.com/terana/Img/master/win_disk_queue.png)

---
### OS X

Зависимость загрузки процессора от количества нагрузочных процессов:
![mac_cpu](https://raw.githubusercontent.com/terana/Img/master/mac_cpu_usage.png)

----
Зависимость доступной оперативной памяти от количества запущенных процессов, активно аллоцирущих память:
![mac_mem](https://raw.githubusercontent.com/terana/Img/master/mac_memory_available.png)
